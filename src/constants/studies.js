...
import { FaCode, FaDatabase, FaFlag } from "react-icons/fa"
export default [
  {
    id: 1,
  ...
  {
    id: 3,
    icon: <FaFlag className="service-icon" />,
    title: "Accountant",
    text: `I know business rules and how financial information fluid`,
    un: "Manizales University",
  },
]
